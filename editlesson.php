...
if(isset($_REQUEST['requpdate'])){
   ...
   // msg displyed if required field missing
    ...
    $sql = "UPDATE lesson SET lesson_id='$lid', lesson_name='$lname', lesson_desc='$ldesc', course_id='$cid', course_name='$cname', lesson_link='$cprice', course_original_price='$coriginalprice', course_img='$llink' WHERE lesson_id = '$lid'";
